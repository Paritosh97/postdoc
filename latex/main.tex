...
This section discusses the different paradigms used for generating scenarios in urban environments. These paradigms can be broadly classified into procedural, and deep generative approaches.
...
\subsubsection{Deep-Generative Approaches}
