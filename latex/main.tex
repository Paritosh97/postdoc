...
\begin{itemize}
    ...
    \item \textbf{Diffusion guided based on ontology:} Specifying the ontology allows us better controllability of the interaction as well as the scene. Existing models focus on generation from scene graph but not ontology.
\end{itemize}
